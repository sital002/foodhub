...
const CartItem = ({ _id, productName, description, price, images, quantity }: CartItemProps) => {
    ...
    <div className="rounded-md flex mb-6  shadow-md shadow-gray-200 justify-between sm:px-5  md:px-16 lg:px-0 bg-white">
      <div className="flex items-center p-3">
        <div className="flex items-center">
          <input type="checkbox" />
          <Image src={images[0].secure_url} alt={productName} width={50} height={50} className="h-[30px] mx-2" />
        </div>
      ...
      <div className=" p-2 md:flex md:items-center gap-2 ">
        ...
        <RiDeleteBin5Line className="text-2xl cursor-pointer text-gray-500" onClick={deleteCartItem} />
      </div>
    </div>
  );
};
