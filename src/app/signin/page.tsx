  ...
  return (
    ...
    <form onSubmit={handleSubmit(getFormData)}>
      <div className="border-1 border-gray-500 shadow-md shadow-black min-h-[450px] w-[380px] rounded-md py-4 px-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <button type="button" className="w-full h-[40px] rounded-md cursor-pointer text-black my-3 border" onClick={()=>signIn("github",{callbackUrl:process.env.NEXTAUTH_URL,redirect:true})}>Sign in with Github</button>
