    ...
    <>
      <form onSubmit={handleSubmit(getFormData)}>
        <div className="border-1 border-gray-500 shadow-md shadow-black min-h-[450px] w-[380px] rounded-md py-4 px-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <button
            type="button"
            className="w-full h-[40px] rounded-md cursor-pointer text-black my-3 border"
            onClick={() =>
              signIn("github", {
                redirect: true,
          ...
          <Link href={"/signup"}>
            <p className="min-w-[350px] flex justify-center items-center rounded-md cursor-pointer border h-[40px]">
              Sign Up
            </p>
          </Link>
        </div>
